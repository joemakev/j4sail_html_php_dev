                ...
                <div class="row">
                    ...
                    <div class="productList col-md-9">
                        ...
                        <div class="productRow row">
                            <div class="product col-md-4 lineThree">
                            ...
                            <div class="product col-md-4 lineThree">
                                <a href="#">
                                    <figure class="photo">
                                        <img src="assets/img/products/product-list-09.jpg" alt="product">
                                        <div class="overlay"></div>
                                    </figure>
                                    <div class="productInfo">
                                        <div class="productName"><strong>Hardened Stainless Wrench</strong></div>
                                        <p class="price">
                                            <span class="currentPrice">$49.85</span>
                                            <span><button class="btn btn-sm btn-primary addToCart"><i class="fa fa-shopping-cart"></i> Add to Cart</button></span>
                                        </p>
                                    </div>
                                </a>

<?php require_once('php-inc-header.php'); ?>
    ...
    <section id="main">
        ...
        <div class="companyHistory mb60">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="textBlue mb-4"><b>Company History</b></h2>
        ...
        <div class="dedicationBox mb60">
            <div class="container">
                <div class="row mb-3">
                    <div class="col-md-12">
                        <h2 class="textBlue"><b>Dedication to Service</b></h2>
                    </div>
                </div>
                <div class="row">
                    <div class="ccol col-md-7 col-lg-9">
                        <p><b class="textBlue">Offendit eleifend moderatius.</b> Ex vix, quem odio mazim et qui, purto expetendis cotidieque quo cu, veri persius vituperata ei nec. Vivendum intellegat et qui, ei denique consequuntur vix.</p>
                        <p><b class="textBlue">Lorem ipsum dolor.</b> Sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <p><b class="textBlue">Ut enim ad minim veniam.</b> Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        <p><b class="textBlue">Duis aute irure dolor.</b> In reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
                        <p><b class="textBlue">Excepteur sint.</b> Occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        <p><b class="textBlue">Vivendum intellegat et qui.</b> Ei denique consequuntur vix. Scripta periculis ei eam, te pro movet reformidans. Offendit eleifend moderatius ex vix, quem odio mazim et qui, purto expetendis cotidieque quo cu, veri persius vituperata ei nec. </p>
                        <p><b class="textBlue">No epicuri hendrerit.</b> Consetetur sit, sit dicta adipiscing ex, in facete detracto deterruisset duo. Scripta periculis ei eam, te pro movet reformidans. Offendit eleifend moderatius ex vix.</p>

<?php require_once('php-inc-header.php'); ?>
    ...
    <!-- Main Content -->
    <section id="main">
        <div class="pageHeader bgCover mb60" style='background-image:url(assets/img/pixabay-business-bg-activedia.jpg)'>
            <div class="container">
                <div class="row">
